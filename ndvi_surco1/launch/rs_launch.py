...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'rgb_camera.exposure', 'default': '10', 'description': 'RGB camera manual exposure (in microseconds)'},
                           {'name': 'enable_depth',                 'default': 'false', 'description': 'enable depth stream'},
                           {'name': 'enable_infra',                 'default': 'false', 'description': 'enable infra0 stream'},
                           {'name': 'enable_infra1',                'default': 'false', 'description': 'enable infra1 stream'},
                        #    {'name': 'enable_ir_emitter', 'default': 'false', 'description': 'Disable IR emitter'},
                           {'name': 'depth_module.laser_power', 'default': '0.', 'description': 'Set laser power to 0'},
                           ...
                           {'name': 'depth_module.infra_profile',   'default': '640,360,15', 'description': 'infra streams (0/1/2) profile'},
                           {'name': 'depth_module.infra_format',    'default': 'RGB8', 'description': 'infra0 stream format'},
                           {'name': 'depth_module.infra1_format',   'default': 'Y8', 'description': 'infra1 stream format'},
                           {'name': 'depth_module.infra2_format',   'default': 'Y8', 'description': 'infra2 stream format'},
                           {'name': 'depth_module.exposure',        'default': '500', 'description': 'Depth module manual exposure value'},
